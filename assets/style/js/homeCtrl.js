app.controller("homeCtrl", function ($scope) {
  angular.element(document).ready(function () {
    //modal create post
    const createContent = document.querySelector("#create-post");
    const createModel = document.querySelector(".modal-create-post");

    const onpenModel = () => {
      createModel.style.display = "grid";
    };

    createContent?.addEventListener("click", onpenModel);
    ...
    createModel?.addEventListener("click", closeModel);
    //sidebar
